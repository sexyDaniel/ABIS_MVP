...
namespace ABIS.Persistence.Migrations
{
    ...
    [Migration("20220818212001_Change_title_unique")]
    partial class Change_title_unique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABIS.Common.Entities.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyUser", b =>
                {
                    b.HasOne("ABIS.Common.Entities.Company", null)
                        .WithMany()
